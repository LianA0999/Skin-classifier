...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with c1:
        st.markdown("<div class='team-card'><div class='team-avatar'>M</div><div class='team-name'>Muhammad Hashim</div><div class='team-bio'>Hello, I’m Muhammad Hashim and I’m a UTS student currently completing a Master’s degree in Artificial Intelligence.This website is a collaborative effort with Pichaya and Lian to provide an easily accessible way to identify and classify skin conditions through the use of artificial intelligence.</div><div class='team-contact'>muhammad.hashim-1@student.uts.edu.au</div></div>", unsafe_allow_html=True)
    with c2:
        st.markdown("<div class='team-card'><div class='team-avatar'>L</div><div class='team-name'>Lian Alaslani</div><div class='team-bio'>Hello, I'm Lian and I'm a UTS student currently completing deep learning and convolutions neural networks and my bachelor. As an Artificial intelligence student, this project utilises computer vision to achieve a useful day-to-day analysis tool and recommendation system that is customisable to each user. Thank you for checking out this website!</div><div class='team-contact'>lian.m.alaslani-1@student.uts.edu.au</div></div>", unsafe_allow_html=True)
    with c3:
        st.markdown("<div class='team-card'><div class='team-avatar'>P</div><div class='team-name'>Pichaya Viwatassawin</div><div class='team-bio'>Hello, I am Pichaya, but you can call me Aya. I am currently a student studying Bachelor of Artificial Intelligence in the University of Technology Sydney (UTS). This project was created as part of our Deep Learning and Convolutional Neural Network class, to help users learn more about their skin with ease and convenience.</div><div class='team-contact'>pichaya.viwatassawin@student.uts.edu.au</div></div>", unsafe_allow_html=True)
    st.markdown("</div>", unsafe_allow_html=True)
