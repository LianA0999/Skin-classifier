...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with c2:
        st.markdown("<div class='team-card'><div class='team-avatar'>L</div><div class='team-name'>Lian Alaslani</div><div class='team-bio'>Hello, I'm Lian and I'm a UTS student currently completing deep learning and convolutions neural networks and my bachelor. This website is a collaborated effort with Pichaya and Muhammad, to provide an easily accessible way to identify and classify skin through the use of Artifical intelligence.</div><div class='team-contact'>lian.m.alaslani-1@student.uts.edu.au</div></div>", unsafe_allow_html=True)
    with c3:
